 ...
 */
public class CustomerRole_sm extends BaseRole implements Customer{
...
//	public Semaphore semAtTable = new Semaphore(0);
	 ...
	 */
	public CustomerRole_sm(String name, Host host, Cashier cashier, RestaurantGui gui){
		super();
		mName = name;
		mGUI = gui;
		print("Constructor");
	...
	public void msgSitAtTable(Waiter waiter, int tableNum, Menu menu) {
		...
		mTableNum = tableNum;
		mMenu = menu;
		mWaiter = waiter; //(WaiterAgent) waiter;
