package restaurant_davidmca.agent;
...
public abstract class Agent {
     ...
     * the restaurant_davidmca.agent to do something.
     */
    ...
    /**
     * Return restaurant_davidmca.agent name for messages.  Default is to return java instance
     * name.
     */
    ...
    /**
     * Start restaurant_davidmca.agent scheduler thread.  Should be called once at init time.
     */
    ...
    /**
     * Stop restaurant_davidmca.agent scheduler thread.
     */
        ...
        public void run() {
            ...
            while (goOn) {
                try {
                    ...
                    // The restaurant_davidmca.agent sleeps here until someone calls, stateChanged(),
                    // which causes a call to stateChange.give(), which wakes up restaurant_davidmca.agent.
                    stateChange.acquire();
                    //The next while clause is the key to the control flow.
                    //When the restaurant_davidmca.agent wakes up it will call respondToStateChange()
                    //repeatedly until it returns FALSE.
                    //You will see that pickAndExecuteAnAction() is the restaurant_davidmca.agent scheduler.
