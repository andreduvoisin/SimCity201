...
public class SortingHat {
	...
	public static void InstantiateBaseRoles(){
		...
		for (int iRestaurantNum = 1; iRestaurantNum < 2; iRestaurantNum++) {
			sRoleLocations.put(new RestaurantHostRole(null, iRestaurantNum),
					ContactList.cRESTAURANT_LOCATIONS.get(iRestaurantNum));
			sRoleLocations.put(new RestaurantCashierRole(null, iRestaurantNum),
					ContactList.cRESTAURANT_LOCATIONS.get(iRestaurantNum));
			sRoleLocations.put(new RestaurantCookRole(null, iRestaurantNum),
					ContactList.cRESTAURANT_LOCATIONS.get(iRestaurantNum));
			for (int iNumRestaurantWaiters = 0; iNumRestaurantWaiters < sNumRestaurantWaiters; iNumRestaurantWaiters++) {
				sRoleLocations.put(new RestaurantWaiterRole(null,
						iRestaurantNum), ContactList.cRESTAURANT_LOCATIONS
						.get(iRestaurantNum));
			}
		}
